<?php
/**
 * RestaurantPress functions and definitions
 *
 ...
 */
function restaurantpress_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on RestaurantPress, use a find and replace
		* to change 'restaurantpress' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'restaurantpress', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'restaurantpress' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'restaurantpress_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'restaurantpress_setup' );
 ...
 */
function restaurantpress_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'restaurantpress_content_width', 640 );
}
add_action( 'after_setup_theme', 'restaurantpress_content_width', 0 );
 ...
 */
function restaurantpress_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'restaurantpress' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'restaurantpress' ),
...
add_action( 'widgets_init', 'restaurantpress_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'restaurantpress_scripts' );
